...
#define STRING_CONFIG_H_AUTHOR "Bakonyi Ferenc" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "RepRap Prusa i3"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "04492dad-3a34-456d-9cde-f411e7a4522b"
...
#define TEMP_SENSOR_BED 1 // or 5 or 11
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  31.42
    #define DEFAULT_Ki   2.74
    #define DEFAULT_Kd  90.09
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 105.44
  #define DEFAULT_bedKi 7.66
  #define DEFAULT_bedKd 967.43
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 26.5, 2.8, -0.44 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define AVOID_OBSTACLES
    ...
    #define CLIP_W  32  // Bed clip width, should be padded a few mm over its physical size
    #define CLIP_H  20  // Bed clip height, should be padded a few mm over its physical size

    // Obstacle Rectangles defined as { X1, Y1, X2, Y2 }
    #define OBSTACLE1 {                      -5,                  26,     -5 + CLIP_H, 26 + CLIP_W }
    #define OBSTACLE2 { X_BED_SIZE + 5 - CLIP_H,                   3,  X_BED_SIZE + 5,  3 + CLIP_W }
    #define OBSTACLE3 { X_BED_SIZE + 5 - CLIP_H, Y_BED_SIZE - CLIP_W,  X_BED_SIZE + 5,  Y_BED_SIZE }
    #define OBSTACLE4 {                      18, Y_BED_SIZE - CLIP_H,     18 + CLIP_W,  Y_BED_SIZE }
