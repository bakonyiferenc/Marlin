...
#define Z_STEPPER_AUTO_ALIGN
   ...
   */
  #define Z_STEPPER_ALIGN_XY { {  25, 100 }, { 175,  100 } }
...
#define ASSISTED_TRAMMING
  ...
  #define TRAMMING_POINT_XY { {  25, 25 }, { 175,  25 }, { 175, 175 }, { 25, 175 } }
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  37.2727     // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.2f        // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  37.2727     // (Hz) The default dominant resonant frequency on the Y axis.
    #define SHAPING_ZETA_Y  0.3333f     // Damping ratio of the Y axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_RETRACT_FEEDRATE      86.67  // (mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH            2  // (mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE  16.67  // (mm/s) Unload filament feedrate. This can be pretty fast.
  ...
  #define ADVANCED_PAUSE_PURGE_FEEDRATE      3.3  // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
  ...
  #define FILAMENT_UNLOAD_PURGE_RETRACT       45  // (mm) Unload initial retract length.
  #define FILAMENT_UNLOAD_PURGE_DELAY          0  // (ms) Delay for the filament to cool after retract.
  #define FILAMENT_UNLOAD_PURGE_LENGTH       -45  // (mm) An unretract is done, then this length is purged.
